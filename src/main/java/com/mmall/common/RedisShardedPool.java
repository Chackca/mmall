...
//    private static String redis5Ip = PropertiesUtil.getProperty("redis5.ip");
//    private static Integer redis5Port = Integer.parseInt(PropertiesUtil.getProperty("redis5.port"));
//    private static String redis6Ip = PropertiesUtil.getProperty("redis6.ip");
...
//        JedisShardInfo info6 = new JedisShardInfo(redis6Ip,redis6Port,1000*2);
